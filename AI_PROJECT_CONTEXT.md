...
**20.10.2025 - Синхронизация БД и услуги складов:**
- ✅ **СИНХРОНИЗАЦИЯ БД:** Реализована синхронизация production БД на локальный компьютер через `pg_dump`/`pg_restore`
- ✅ **УСЛУГИ СКЛАДОВ:** Добавлена возможность добавлять услуги от разных складов к одному автомобилю
