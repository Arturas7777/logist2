...
1. Хранение (только для Company): `{car.days} дней × ставка из услуги "Хранение"` + статус `[Передан]` или `[Текущее хранение]`
2. Все услуги складов (от всех складов, не только основного)
3. Все услуги линий
4. Все услуги перевозчиков
5. Скрытая наценка добавляется в цены услуг через `markup_amount` (отдельной строкой не выводится)
