...
class CarModelImage(models.Model):
    ...
    например «BMW 430I») и ``year`` как поколение: фото года Y показывается
    на авто с годом >= Y до следующего поколения.
    """
    ...
    year = models.PositiveIntegerField(
        ...
        blank=True,
        verbose_name="Год",
        help_text="Год поколения: картинка для авто этой марки с этим и более поздним годом, пока нет фото новее. Пусто = любой год.",
    )
