...
class InvoiceAudit(models.Model):
    ...
    total_amount = models.DecimalField(
        max_digits=12, decimal_places=2, null=True, blank=True, verbose_name="Сумма счёта"
    )
...
class SupplierCost(models.Model):
    ...
    car = models.ForeignKey(
        Car, on_delete=models.CASCADE, null=True, blank=True, related_name="supplier_costs", verbose_name="Машина"
    )
    car_service = models.ForeignKey(
        CarService,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="supplier_costs",
        verbose_name="Услуга в карточке",
    )
    ...
    source = models.CharField(max_length=10, choices=SOURCE_CHOICES, default="INVOICE", verbose_name="Источник")
