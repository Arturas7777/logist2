...
class ScanProcessingJob(models.Model):
    ...
    scan_type = models.CharField(max_length=20, choices=SCAN_TYPE_CHOICES, db_index=True,
                                 verbose_name="Тип скана")
    ...
    linked_car = models.ForeignKey(
        'core.Car', on_delete=models.SET_NULL, null=True, blank=True,
        related_name='scan_jobs', verbose_name="Связанный автомобиль",
    )
    linked_container = models.ForeignKey(
        'core.Container', on_delete=models.SET_NULL, null=True, blank=True,
        related_name='scan_jobs', verbose_name="Связанный контейнер",
    )
    ...
    created_by = models.ForeignKey(
        ...
        related_name='scan_jobs_created', verbose_name="Загрузил",
    )
    applied_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='scan_jobs_applied', verbose_name="Применил",
    )
