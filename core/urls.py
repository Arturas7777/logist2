...
urlpatterns = [
    ...
    path(
        "container/<int:container_id>/sync-gdrive-photos/",
        views.sync_container_photos_from_gdrive,
        name="sync_container_photos_gdrive",
    ),
    path(
    ...
    path(
        "emails/container/<int:container_id>/mark-all-read/",
        views.email_mark_container_read,
        name="email_mark_container_read",
    ),
    ...
    path("emails/car/<int:car_id>/updates/", views.email_car_updates, name="email_car_updates"),
    path(
        "emails/autotransport/<int:at_id>/mark-all-read/",
        views.email_mark_autotransport_read,
        name="email_mark_autotransport_read",
    ),
    path(
        "emails/autotransport/<int:at_id>/updates/",
