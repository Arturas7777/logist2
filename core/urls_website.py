...
urlpatterns = [
    ...
    path(
        "photo/container/<int:photo_id>/download/",
        views_website.download_container_photo,
        name="download_container_photo",
    ),
    ...
    path(
        "api/container-photos/<str:container_number>/", views_website.get_container_photos, name="get_container_photos"
    ),
