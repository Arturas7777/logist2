...
class CarPhotoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CarPhoto
        fields = ["id", "car", "photo", "photo_url", "photo_type", "description", "uploaded_at", "filename"]
...
class ContainerPhotoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "container", "photo", "photo_url", "photo_type", "description", "uploaded_at", "filename"]
        read_only_fields = ["uploaded_at", "filename"]
...
class ClientCarSerializer(serializers.ModelSerializer):
    ...
    def get_container_photos(self, obj):
        if not obj.container:
            return []
        if hasattr(obj.container, "_prefetched_objects_cache") and "photos" in obj.container._prefetched_objects_cache:
...
class AIChatSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AIChat
        fields = ["id", "session_id", "message", "response", "created_at", "processing_time", "was_helpful"]
...
class TrackingRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "tracking_number", "email", "car_info", "container_info", "created_at"]
