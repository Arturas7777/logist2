...
class BankTransactionAdmin(CSVExportMixin, admin.ModelAdmin):
    ...
    def create_expense_view(self, request, pk):
        ...
        from core.models.billing import ExpenseCategory, NewInvoice
        ...
        try:
            ...
            # вьюха только парсит форму и показывает сообщения.
    ...
    def create_expenses_bulk(self, request, queryset):
        ...
        from core.models import Company
        from core.models.billing import ExpenseCategory, InvoiceItem, NewInvoice
