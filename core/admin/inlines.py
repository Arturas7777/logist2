...
class ServiceInlineLabelsMixin:
    ...
    _SERVICE_HELP = {
        "default_markup": (
            "Наценка по умолчанию только для новых авто. Уже проставленные наценки на существующих машинах не перезаписываются."
        ),
        "is_active": (
            "Активна ли услуга. Если выключено — услуга не предлагается и не добавляется при создании авто/контейнера."
        ),
        "add_by_default": (
            "Добавлять автоматически. Если включено — услуга по умолчанию добавляется к каждому новому авто/контейнеру."
        ),
    }
