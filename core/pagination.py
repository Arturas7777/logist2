...
def paginated_json_response(page, paginator, data_key="results"):
    ...
    """
    response_data = {data_key: list(page.object_list), "pagination": get_pagination_info(page, paginator)}
...
class PaginationHelper:
    ...
    def page(self):
        ...
        if self._page is None:
            self._page, self._paginator = paginate_queryset(self.queryset, self.request, self.per_page)
        return self._page
