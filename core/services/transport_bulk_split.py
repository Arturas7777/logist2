...
- PASSPORT — страница паспорта физлица ИЛИ пластиковая ID-карта
  (идентификационная карта РБ, литовская asmens kortelė и т.п.: фото,
  MRZ, номер паспорта / номер карты).
