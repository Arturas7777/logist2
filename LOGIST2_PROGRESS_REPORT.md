...
### 13. Улучшенная система фотографий контейнеров (21.01.2026)
...
### 14. Исправления поиска на клиентском сайте (21.01.2026)
...
| 21.01.2026 | Улучшенная система фотографий: автосинхронизация с Google Drive, разделение по типам, галерея с вкладками в админке и на клиентском сайте |
| 21.01.2026 | Улучшение Lightbox: прозрачные кнопки, скрытие при зуме, touch-жесты (pinch-zoom, swipe) |
