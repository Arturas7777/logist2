...
### Changed — Хлебные крошки кликабельны и не пропадают на карточках (2026-08-24)

- Крошки вынесены в `admin/includes/topbar_crumbs.html` и подключены на
  карточках авто, контейнера, автовоза и инвойса — раньше эти страницы
  перекрывали блок своим заголовком, и вернуться к списку одним кликом
  было нельзя.
...
- Топбар ограничен по ширине, чтобы длинные крошки не наезжали на логотип;
  на экранах уже 1250 px остаётся только ссылка на список.
